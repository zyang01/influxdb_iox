...
decorate!(
    ...
    methods = [
        ...
        "recent_highest_throughput_partitions" = recent_highest_throughput_partitions(&mut self, sequencer_id: SequencerId, num_hours: i32, min_num_files: i32, num_partitions: i32 ) -> Result<Vec<PartitionParam>>;
        "most_level_0_files_partitions" =  most_level_0_files_partitions(&mut self, sequencer_id: SequencerId, num_partitions: i32) -> Result<Vec<PartitionParam>>;
    ]
);
