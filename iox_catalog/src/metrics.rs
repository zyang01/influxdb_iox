...
decorate!(
    ...
    methods = [
        ...
        "recent_higest_throughput_partitions" = recent_higest_throughput_partitions(&mut self, sequencer_id: SequencerId, num_hours: i32, min_num_files: i32, num_partitions: i32 ) -> Result<Vec<PartitionParam>>;
