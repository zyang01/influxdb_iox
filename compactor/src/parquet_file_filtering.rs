...
pub(crate) fn filter_parquet_files(
    ...
    for level_0_file in level_0 {
        ...
        total_level_0_bytes += level_0_file.file_size_bytes;
        ...
        total_level_1_bytes += overlaps.iter().map(|f| f.file_size_bytes).sum::<i64>();
...
mod tests {
    ...
    const DEFAULT_MAX_FILE_SIZE: i64 = 1024 * 1024 * 10;
